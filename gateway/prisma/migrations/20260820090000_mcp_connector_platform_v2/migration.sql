...
ALTER TABLE "operations"
  ...
  ADD COLUMN IF NOT EXISTS "connectorSlug" TEXT,
  ADD COLUMN IF NOT EXISTS "accountLabel" TEXT,
  ADD COLUMN IF NOT EXISTS "toolClassification" TEXT,
  ADD COLUMN IF NOT EXISTS "auditSummary" JSONB;
...
CREATE UNIQUE INDEX IF NOT EXISTS "connector_definitions_slug_key" ON "connector_definitions"("slug");
CREATE INDEX IF NOT EXISTS "connector_definitions_category_isActive_idx" ON "connector_definitions"("category", "isActive");
CREATE UNIQUE INDEX IF NOT EXISTS "app_connections_storeId_connectorDefinitionId_label_key" ON "app_connections"("storeId", "connectorDefinitionId", "label");
CREATE INDEX IF NOT EXISTS "app_connections_userId_storeId_status_idx" ON "app_connections"("userId", "storeId", "status");
CREATE INDEX IF NOT EXISTS "app_connections_connectorDefinitionId_status_idx" ON "app_connections"("connectorDefinitionId", "status");
CREATE UNIQUE INDEX IF NOT EXISTS "agent_connection_grants_agentId_connectionId_key" ON "agent_connection_grants"("agentId", "connectionId");
CREATE INDEX IF NOT EXISTS "agent_connection_grants_connectionId_idx" ON "agent_connection_grants"("connectionId");
CREATE UNIQUE INDEX IF NOT EXISTS "agent_tool_policies_agentId_connectionId_toolName_key" ON "agent_tool_policies"("agentId", "connectionId", "toolName");
CREATE INDEX IF NOT EXISTS "agent_tool_policies_connectionId_idx" ON "agent_tool_policies"("connectionId");
CREATE INDEX IF NOT EXISTS "connector_audit_events_storeId_createdAt_idx" ON "connector_audit_events"("storeId", "createdAt");
CREATE INDEX IF NOT EXISTS "connector_audit_events_connectionId_createdAt_idx" ON "connector_audit_events"("connectionId", "createdAt");
CREATE UNIQUE INDEX IF NOT EXISTS "connector_oauth_states_nonceHash_key" ON "connector_oauth_states"("nonceHash");
CREATE INDEX IF NOT EXISTS "connector_oauth_states_expiresAt_consumedAt_idx" ON "connector_oauth_states"("expiresAt", "consumedAt");
CREATE INDEX IF NOT EXISTS "operations_connectionId_startedAt_idx" ON "operations"("connectionId", "startedAt");
CREATE INDEX IF NOT EXISTS "approval_requests_connectionId_createdAt_idx" ON "approval_requests"("connectionId", "createdAt");
